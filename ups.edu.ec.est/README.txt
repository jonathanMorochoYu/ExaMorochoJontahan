...
a persistence unit "ups.edu.ec.estPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ExaMorochoJonathan/ups/edu/ec/est/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "ups.edu.ec.est/pom.xml":
...
artifact ("ups.edu.ec.est.war") is already built. You can build
